                    ...
                    <nav className="navbar navbar-expand-lg navbar-light">
                        <div className="container-fluid p-3">
                            <div className='row w-100 p-0'>
                                ...
                                <div className="col-md-6 d-flex justify-content-end align-items-center collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul className="navbar-nav bg-white p-2 rounded align-items-center gap-2 ps-3">
                                        ...
                                        <li className="nav-item">
                                            <a className="nav-link fw-bold text-dark" href="#">Hair Transplant Result</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link fw-bold text-dark" href="#">Hair Restoration</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link fw-bold text-dark" href="#">Cost</a>
                                        </li>
                                        <li>
